...
class _InputPrimaryState extends State<InputPrimary> {
    ...
    if (widget.inputStyle == InputStyle.box) {
      switch (tState) {
        case TextFieldState.focus:
          return _box(borderColor: primaryColor);
        case TextFieldState.error:
          return _box(borderColor: Colors.red);
        case TextFieldState.none:
          return _box(borderColor: widget.outlineColor ?? blackColor1);
      ...
      switch (tState) {
        case TextFieldState.focus:
          return _line(borderColor: primaryColor);
        case TextFieldState.error:
          return _line(borderColor: Colors.red);
        case TextFieldState.none:
          return _line(
            borderColor: widget.outlineColor ?? blackColor1,
          );
        case TextFieldState.disabled:
          return _line(
            borderColor: widget.outlineColor ?? blackColor1,
      ...
      switch (tState) {
        case TextFieldState.focus:
          return _outline(borderColor: primaryColor);
        case TextFieldState.error:
  ...
  _box({required Color borderColor}) {
    return BoxDecoration(
      color: widget.color ?? blackColor1,
